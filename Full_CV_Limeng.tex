...
\item Committee: Dr. Kevin Crosby, Dr. Patricia Klein \& Dr. John Jifon, Vegetable Breeding Lab
...
\item Current project: Design and excute experiments to study root architecture diversity of crop roots, using common bean as a model species
...
\item Obtained a opitmal ratio of dairy manure and sweetpotato vine (2:8) to achieve stable methane production
\end{cvitems}}
\end{cventries}
...
\end{cvitems}}
    \cventry{Mentor}{University of Georgia}{Athens, GA}{2020 Summer}{\begin{cvitems}
...
\item Joslyn Mcklveen, CURO Project: Analyze the effect of temperature and humidity on plant development on a newly-developed mesocosm system
\end{cvitems}}
    \cventry{Mentor}{Texas A\&M University}{College Station, TX}{May 2017 - Dec 2017}{\begin{cvitems}
\item Trained 8 undergraduates of pepper and tomato breeding
\end{cvitems}}
\end{cventries}
\pagebreak
